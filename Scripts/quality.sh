...
coverage_exclusions='/\.build/|/Tests/|/Sources/TouchpadWM/TouchpadWMApp\.swift$|/Sources/TouchpadWM/AccessibilityWindowService\.swift$|/Sources/TouchpadWMSpike/MultitouchBridge\.swift$|/Sources/TouchpadWMSpikeConsole/main\.swift$'
